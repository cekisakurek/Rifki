...
//            if !self.isScaleSet && scrollView.contentSize.width > 20.0 {
//                let scaleX = scrollView.frame.size.width / scrollView.contentSize.width
//                let scaleY = scrollView.frame.size.height / scrollView.contentSize.height
//                scrollView.zoomScale = min(scaleX, scaleY)
//                self.isScaleSet = true
//            }
        }
